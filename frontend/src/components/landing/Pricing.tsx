    ...
    <section id="pricing" className="px-0 py-[120px] max-md:py-[80px]">
      <div className="mx-auto max-w-[var(--maxw)] px-7">
        ...
        <div ref={plansRef} className="reveal mx-auto grid max-w-[800px] grid-cols-2 gap-6 max-md:grid-cols-1">
          ...
          <div className="featured-plan flex flex-col rounded-2xl border p-[42px] px-[34px] transition-all hover:-translate-y-[3px]" style={{ background: "var(--bg-card)", borderColor: "var(--gold)", boxShadow: "0 0 0 1px var(--gold)" }}>
