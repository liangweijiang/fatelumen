...
const zh: Readonly<Record<string, string>> = {
  ...
  input:"输入资料",time_calculation:"时间换算",chart:"命盘",meta:"基础信息",pillars:"四柱",day_master:"日主",hour_unknown:"时辰是否未知",five_elements_count:"五行数量",element_power:"五行力量",element_strength:"五行力量",strength:"身强弱",strength_v2:"身强弱计算明细",day_master_strength:"日主强弱",
